...
<head>
  ...
  <title>AdaApa.com</title>
</head>

<body>

  <div class="container">
    <h1 class="align-midcle">Daftar Artikel</h1>
    ...
    <div class="intro">
      <h2 class="text-center" id="Produk" style="margin-top: 110px">Artikel</h2>
    </div>
    <div class="tab-content">
      <div class="row">
        <?php if (empty($edukasi)) : ?>
          <div class="col-md-12">
            <h1 class="text-center">Data tidak ditemukan!</h3>
          </div>
        <?php endif; ?>
      </div>
      <div class="tab-pane active" role="tabpanel" id="tab-1">
        <div class="card-group">
          <div class="container-fluid">
            <div class="row">
              <?php foreach ($edukasi as $row) : ?>
                <div class="col-md-4">
                  <div class="card shadow mt-3">
                    <img class="card-img-top img-fluid max-foto" src="img/<?= $row['gambar']; ?>" style="max-height: 300px; min-height: 250px; max-width: 400px;">
                    <div class="card-body">
